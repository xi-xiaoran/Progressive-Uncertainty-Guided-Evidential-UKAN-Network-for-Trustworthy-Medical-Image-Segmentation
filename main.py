...
if Train:
    ...
    for train_index, val_index in kf.split(dataset):
        ...
        # model = PUGEUKAN(input_channels=3,
        ...
        model = train_model(model, train_loader, val_loader, criterion, optimizer, device, uncertainty,
                            num_epochs=num_epochs, zhe=num, likehood=likehood)
        ...
        Dice, Iou, Assd, ECE, UEO = evaluate_model(model, test_loader, device, uncertainty, likehood)
        print()
        print('Dice', Dice)
        print('Iou', Iou)
        print('ASSD', Assd)
